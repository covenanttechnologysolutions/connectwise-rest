...
export default class FeatureFlagsAPI extends Automate {
  constructor(props: CWAOptions) {
   ...
   FeatureFlags_GetFeatureFlagList(params: CommonParameters = {}): Promise<object> {
    return this.request({
      path: `/api/v1/FeatureFlags`, method: 'get', params
    })
   }

   FeatureFlags_PostFeatureFlag(: LabTechModelsFeatureFlag): Promise<LabTechModelsFeatureFlag> {
    return this.request({
      path: `/api/v1/FeatureFlags`, method: 'post', data: 
    })
   }
}
